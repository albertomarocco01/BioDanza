...
export default function Footer() {
    ...
    return (
        <footer className="w-full bg-primary-dark/30 border-t border-text-primary/10 py-6 px-8 mt-auto">
            ...
            <div className="max-w-7xl mx-auto pt-6 mt-8 border-t border-text-primary/10 flex flex-col md:flex-row justify-between items-center text-xs font-serif opacity-50">
