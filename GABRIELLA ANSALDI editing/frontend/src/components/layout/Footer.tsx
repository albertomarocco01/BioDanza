...
export default function Footer() {
    ...
    return (
        <footer className="w-full bg-[#FDF9ED] border-t border-text-primary/10 py-8 px-8">
            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-text-primary">
                ...
                <div className="flex flex-col items-center text-center space-y-2">
                    <Link href="/" onClick={handleBrandClick} className="inline-block group">
                        <div className="relative w-32 h-16 mx-auto transition-transform duration-300 group-hover:scale-105">
                            <Image
                                src="/LogoFooter.png"
                    ...
                    <div className="flex justify-center space-x-3 pt-1">
                        <a href="https://www.facebook.com/m.gabry.ansaldi" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                            className="w-8 h-8 rounded-full border border-blue-800/40 text-blue-800/90 flex items-center justify-center hover:bg-blue-800 hover:border-blue-800 hover:text-[#FDF9ED] transition-all p-1.5">
                        ...
                        <a href="https://www.instagram.com/gabrybiodanza/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                            className="w-8 h-8 rounded-full border border-rose-600/40 text-rose-600/90 flex items-center justify-center hover:bg-rose-600 hover:border-rose-600 hover:text-[#FDF9ED] transition-all p-1.5">
