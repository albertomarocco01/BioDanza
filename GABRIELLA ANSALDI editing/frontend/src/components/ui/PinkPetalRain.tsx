...
export default function PinkPetalRain({ scrollContainer }: { scrollContainer: React.RefObject<HTMLDivElement | null> }) {
  ...
  useEffect(() => {
    ...
    const draw = (now: number) => {
      ...
      petalsRef.current.forEach((petal, index) => {
        ...
        // ─── PINK: petalo rosa cipria, bordo rosa più scuro ───
        ctx.fillStyle = `rgba(242, 185, 195, ${alpha})`;
        ctx.strokeStyle = `rgba(196, 130, 148, ${alpha * 0.7})`;
