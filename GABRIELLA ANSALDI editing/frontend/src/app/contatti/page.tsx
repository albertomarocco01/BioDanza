                ...
                <div className="space-y-12 relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
                        <div className="space-y-4">
                            ...
                            <a href="tel:+390000000000" className="block font-serif text-2xl md:text-3xl hover:text-accent-biodanza transition-colors">
                                +39 000 000 0000
                            </a>
                        </div>
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex justify-center space-x-6">
                            <a href="#" className="w-16 h-16 rounded-full border border-text-primary/20 flex items-center justify-center hover:bg-text-primary hover:text-primary transition-all text-xl font-display">FB</a>
                            <a href="#" className="w-16 h-16 rounded-full border border-text-primary/20 flex items-center justify-center hover:bg-text-primary hover:text-primary transition-all text-xl font-display">IG</a>
                        </div>
                    </div>
                </div>
            </motion.div>
